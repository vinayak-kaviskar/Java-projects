...
public class QueuesGettingStarted {
 ...
 public void run(String connectionString) throws Exception {
     ...
     QueueClient receiveClient = new QueueClient(new ConnectionStringBuilder(connectionString, "sb-queue-ota-status-cpg"), ReceiveMode.PEEKLOCK);
     ...
     queueClient.registerMessageHandler(new IMessageHandler() {
                                            ...
                                            public CompletableFuture<Void> onMessageAsync(IMessage message) {
                                                ...
                                                if (message.getBody() != null) {
                                                    ...
                                                    Map eventBody = GSON.fromJson(new String(body, UTF_8), Map.class);
                                                    ...
                                                    System.out.printf(
                                                            ...
                                                            eventBody != null ? eventBody.get("firstName") : "",
                                                            eventBody != null ? eventBody.get("name") : "");
                                                    System.out.println(eventBody.toString());
                                                }
